...
const Privacy = () => (
  <div style={{ padding: "20px" }}>
    ...
    <p>
      ...
      and/or collect in Tasty Base. This policy is not applicable to any
    ...
    <p>
      Tasty Base follows a standard procedure of using log files. These files
    ...
    <p>
      ...
      advertising partners of Tasty Base.
    </p>

    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on Tasty Base, which are sent
    ...
    <p>
      Note that Tasty Base has no access to or control over these cookies that
    ...
    <p>
      Tasty Base&apos;s Privacy Policy does not apply to other advertisers or
    ...
    <p>
      Tasty Base does not knowingly collect any Personal Identifiable
